...
extern int register_tm2_layernorm_op();
...
extern int unregister_tm2_layernorm_op();
...
int register_all_tm2_ops()
{
    ...
    ret = register_tm2_layernorm_op();
    if(0 != ret)
    {
        TLOG_ERR("Tengine FATAL: Call %s failed(%d).\n", "register_tm2_layernorm_op()", ret);
    }
...
int unregister_all_tm2_ops()
{
    ...
    ret = unregister_tm2_layernorm_op();
    if(0 != ret)
    {
        TLOG_ERR("Tengine FATAL: Call %s failed(%d).\n", "register_tm2_layernorm_op()", ret);
    }
