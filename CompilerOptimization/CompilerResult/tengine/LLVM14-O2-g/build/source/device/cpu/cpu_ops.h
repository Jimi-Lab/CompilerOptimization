...
extern int register_layernorm_ref_op();
...
extern int unregister_layernorm_ref_op();
...
int register_all_cpu_ops()
{
    ...
    ret = register_layernorm_ref_op();
    if(0 != ret)
    {
        TLOG_ERR("Tengine FATAL: Call %s failed(%d).\n", "register_layernorm_ref_op()", ret);
    }
...
int unregister_all_cpu_ops()
{
    ...
    ret = unregister_layernorm_ref_op();
    if(0 != ret)
    {
        TLOG_ERR("Tengine FATAL: Call %s failed(%d).\n", "register_layernorm_ref_op()", ret);
    }
